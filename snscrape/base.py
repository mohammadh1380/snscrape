...
class Scraper:
	...
	def __init__(self, *, retries = 10, proxies = None):
	...
	def _request(self, method, url, params = None, data = None, headers = None, timeout = 10, responseOkCallback = None, allowRedirects = True, proxies = None, redis_obj=None):
		if not headers:
			headers = {}
